            ...
            <a href="${driverF1Url}" target="_blank" style="text-decoration:none;color:inherit;display:block;">
                <div class="driver-image-area">
                    <img src="./Drivers/${d.id}.PNG" class="driver-portrait"
                         onerror="this.onerror=null;this.src='./Drivers/placeholder.png'">
...
function openGallery(teamId, photoCount = 5) {
    ...
    for (let i = 1; i <= photoCount; i++) {
        ...
        html += `<img src="./Cars/${teamId}-${i}.${ext}" onerror="this.onerror=null;this.src='https://placehold.co/800x450/111/333?text=No+Image'">`;
    }
...
function tryNextExt(img, teamId, num) {
    ...
    if (next) { img.setAttribute('data-ext', next); img.src = `./Cars/${teamId}-${num}.${next}`; }
