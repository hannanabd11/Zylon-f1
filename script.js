    ...
    if (isLive) {
        ...
        display.innerHTML = `
            <div style="display:flex;flex-direction:column;gap:8px;align-items:center;">
                ...
                <a href="https://www.formula1.com/en/racing/2026/${race.gp.replace(/\s+/g,'-')}"
                   target="_blank" rel="noopener noreferrer"
                   class="live-btn-link"
                   style="pointer-events:auto;position:relative;z-index:999;display:inline-block;">
                    RACE HUB ➔
            ...
            <div class="standings-entry" style="--team-glow:${teamColor}">
                ...
                <div class="entry-name">
                    ...
                    <div class="driver-name-row" style="display:flex;align-items:center;">
                        ...
                        <a href="https://www.google.com/search?q=${item.Driver.givenName}+${item.Driver.familyName}+F1+2026"
